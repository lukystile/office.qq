        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    <li class="active">
                        <a href="<?= yii\helpers\Url::to(['/']); ?>" class="waves-effect waves-button">
                            <span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?= yii\helpers\Url::to(['/user']); ?>" class="waves-effect waves-button">
                            <span class="menu-icon glyphicon glyphicon-user"></span><p>Users</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?= yii\helpers\Url::to(['/rbac']); ?>" class="waves-effect waves-button">
                            <span class="menu-icon glyphicon glyphicon-user"></span><p>Roles and Premission</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?= yii\helpers\Url::to(['/client']); ?>" class="waves-effect waves-button">
                            <span class="menu-icon glyphicon glyphicon-user"></span><p>Clients</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?= yii\helpers\Url::to(['/project']); ?>" class="waves-effect waves-button">
                            <span class="menu-icon glyphicon glyphicon-briefcase"></span></span><p>Projects</p>
                        </a>
                    </li>
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-envelope"></span><p>Mailbox</p><span class="arrow"></span></a>
                        <ul class="sub-menu">
                            <li><a href="<?= yii\helpers\Url::to(['/role-premission']); ?>">RolePremission</a></li><!-- href = 'index.html'-->
                            <li><a href="<?= yii\helpers\Url::to(['/new-client']); ?>">Inbox Alt</a></li>
