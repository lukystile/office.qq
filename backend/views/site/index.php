...
$this->registerJsFile(Yii::$app->request->BaseUrl . '/js/pages/dashboard.js', ['depends' => 'backend\assets\AppAsset']);
?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="weather-top">
                                        ...
                                        <h2 class="weather-day pull-right">Miami, FL<br><small><b>18th April, 2018</b></small></h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
