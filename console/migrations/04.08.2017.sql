...
INSERT INTO `strength_exercise` VALUES (1,8,1,'Shoulders','Barbell','10','12','15gk'),(2,8,2,'Chest','Bodyweight','15','20','25kg'),(3,9,1,'Shoulders','Barbell','40','20','14kg');
...
INSERT INTO `strength_plan` VALUES (5,'Level','Plan Desc','Details','Recheck'),(6,'Strength Training','PLAN DESCRIPTION','DETAILS','RECHEK'),(7,'Level','PLAN DESCRIPTION','DETAILS','RECHEK'),(8,'Strength Level 2','PLAN DESCRIPTION','DETAILS','RECHEK');
...
CREATE TABLE `strength_week` (
  ...
  CONSTRAINT `fk_strength_plan_id` FOREIGN KEY (`plan_id`) REFERENCES `strength_plan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `strength_week` VALUES (3,5),(4,5),(5,6),(6,6),(7,7),(8,8),(9,8);
...
-- Dump completed on 2017-08-04  1:05:08
